...
<form method="POST">
  <div class="mb-3">
    ...
    <input type="text" class="form-control" id="nomeAluno" name="txtNome">
  </div>
  <div class="mb-3">
      <label for="nomeCurso" class="form-label">Curso</label>
      <select id="nomeCurso" class="form-select" name="cbxCurso">
        <option value="">...</option>
        <?php
            if($listaDeCurso){
